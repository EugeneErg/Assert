...
final readonly class CountBetweenRule extends AbstractRule
{
    public function __construct(
        ...
        parent::__construct(new MultiRule(
            false,
            new CountLessThanRule($this->from, $this->root, $this->fromEqual),
            new CountLessThanRule($this->root, $this->to, $this->toEqual),
        ));
    }
