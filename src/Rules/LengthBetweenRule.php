...
final readonly class LengthBetweenRule extends AbstractRule
{
    public function __construct(
        ...
        parent::__construct(new MultiRule(
            false,
            new lengthLessThanRule($this->from, $this->root, $this->fromEqual),
            new lengthLessThanRule($this->root, $this->to, $this->toEqual),
        ));
    }
